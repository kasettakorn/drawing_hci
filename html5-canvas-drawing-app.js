...
mouseY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - this.offsetTop;
				...
				if (mouseX < drawingAreaX) { // Left of the drawing area
					if (mouseX > mediumStartX) {
						if (mouseY > mediumStartY && mouseY < mediumStartY + mediumImageHeight) {
							curColor = colorPurple;
							commandStack.innerHTML += "<br>Choose purple " + curTool + ".";
						} else if (mouseY > mediumStartY + mediumImageHeight && mouseY < mediumStartY + mediumImageHeight * 2) {
							curColor = colorGreen;
							commandStack.innerHTML += "<br>Choose green " + curTool + ".";
						} else if (mouseY > mediumStartY + mediumImageHeight * 2 && mouseY < mediumStartY + mediumImageHeight * 3) {
							curColor = colorYellow;
							commandStack.innerHTML += "<br>Choose yellow " + curTool + ".";
						} else if (mouseY > mediumStartY + mediumImageHeight * 3 && mouseY < mediumStartY + mediumImageHeight * 4) {
							curColor = colorBrown;
							commandStack.innerHTML += "<br>Choose brown " + curTool + ".";
						}
					}
					...
					if (mouseY > toolHotspotStartY) {
						if (mouseY > sizeHotspotStartY) {
							...
							if (mouseY < sizeHotspotStartY + sizeHotspotHeight && mouseX > sizeHotspotStartX) {
								...
								commandStack.innerHTML += "<br>Choose " +  curSize + " size.";
							}
						} else {
							...
							commandStack.innerHTML += "<br>Choose " + curTool + ".";
			...
			undo = function() {
				redoClickX.push(clickX.pop()) 
				redoClickY.push(clickY.pop())
				redoDrag.push(clickDrag.pop())
				redraw();
			},
			redo = function () {
				clickX.push(redoClickX.pop());
				clickY.push(redoClickY.pop());
				clickDrag.push(redoDrag.pop());	
				redraw();			
			},
			cancel = function () {
				paint = false;
		...
		init = function () {
			...
			commandStack = document.createElement("P");
			commandStack.innerHTML = "======Command Stack======"
			document.getElementById('canvasDiv').appendChild(canvas);
			document.getElementById('canvasDiv').appendChild(undoBtn);
			document.getElementById('canvasDiv').appendChild(redoBtn);
			document.getElementById('canvasDiv').appendChild(commandStack);
